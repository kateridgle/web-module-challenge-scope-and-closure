...
function scoreboard(inningScoreCB, inningScore, number) {
  const scoreByinning = [];
  let homeScore = 0;
  let awayScore = 0;
  ...
  if ( homeScore === awayScore){
    scoreByInning.push(`This game will require extra innings: Away ${currentInning} - Home ${currentInning.Home}`)
  }
  else {
